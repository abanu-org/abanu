...
namespace lonos.kernel.core
{
    ...
    unsafe public static class PageTable2
    {
        private const uint pageDirectoryAddress = Address.PageDirectory;

        private const uint pageTableAddress = Address.PageTable;
